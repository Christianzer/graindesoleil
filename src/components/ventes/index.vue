<template>
  <div class="container-fluid p-3">
    <PageHeader title="Faire une vente" subtitle="Sélectionnez un client pour démarrer" crumb="Ventes">
      <template #actions>
...
export default {
  ...
  methods: {
    ...
    async factures(dataPat) {
      flow.setClients(dataPat)
      this.$router.push({name:'ventes_historiques'})
    }
  },
